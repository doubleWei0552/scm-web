...
//详情页新增模块
export default class AddDetailPage extends React.Component {
  componentDidMount=()=>{
    ...
    return (
        <div className={styles.DetailMain} >
          <SkeletonCom type='detailPage' loading={loadingG || false} />
            ...
            {/* 头部title/面包屑 */}
            <CustomerHeader />
            <Detailbuttons saveType='save' location={this.props.location} detailForm={this.DetailPage} />
            ...
            >
                ...
                <ChildTable newAdd={true} disEditStyle={false} getMasterTable={(value) => this.getMasterTable(value)} />
                </div>
            </Card>
            </div>
        </div>
